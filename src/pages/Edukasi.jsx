    ...
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        {loading ? (
          ...
          <div style={{ background: "#fff", padding: "30px", borderRadius: "18px", textAlign: "center", color: "#556B4D", border: "2px solid #C8E6C9", fontWeight: "600" }}>
      ...
      {selectedMateri && (
        <div style={styles.modalOverlay} onClick={() => setSelectedMateri(null)}>
          <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <h2 style={{ color: "#1B5E20", marginTop: "10px", fontSize: "20px", fontWeight: "800" }}>
              {selectedMateri.judul}
            </h2>
            <hr style={{ border: "none", borderBottom: "2px solid #E8F5E9", margin: "15px 0" }} />
            <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#2E3D29", whiteSpace: "pre-line" }}>
              {selectedMateri.isi}
            </p>
            <button
